...
public class TasksPrioritizedListGetHandler extends BaseHttpHandler {
  public TasksPrioritizedListGetHandler(TaskManager taskManager) {
    super(taskManager);
  }
  ...
  protected void handleRequest(HttpExchange exchange, Map<String, String> pathParameters)
      throws IOException,
          ...
          OverlapException {
    ResponseUtility.sendJsonOkResponse(exchange, taskManager.getPrioritizedTasks());
  }
}
